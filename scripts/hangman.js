...
module.exports = function () {
    ...
    this.showRules = function (src) {
        var rules = [
            ...
            "±Rules: Hangman Admins are here for the benefit of the channel. If you are asked to do something by a Hangman Admin, it is advised you do so. Insulting of HAs will result in punishment.",
