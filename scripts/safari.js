...
function Safari() {
    ...
    */
    ...
    this.gachapon = function (src, commandData, freeUse) {
        ...
        if (cantBecause(src, "use the Gachapon Machine", ["item", "auction", "battle", "pyramid", "event", "tutorial"], (freeUse ? null : "gacha"))) {
            return;
        }
        var currentTime = now();
