exports.handleCommand = function(src, command, commandData, tar, channel) {
    ...
    if ((command == "me" || command == "rainbow") && !SESSION.channels(channel).muteall) {
        ...
        else if (command == "rainbow" && SESSION.global().allowRainbow && channel !== 0 && channel !== tourchannel && channel !== mafiachan && channel != sys.channelId("Trivia") && channel != sys.channelId("Hangman")) {
