exports.handleCommand = function(src, command, commandData, tar, channel) {
    ...
    if (command === "addtouralert" || command === "addtouralerts" || command === "removetouralert" || command === "removetouralerts") {
        ...
        var verb = "add", verbtensed = "added", adverb = "already";
        ...
        for (x = 0; x < inputArray.length; x++) {
            ...
            } else if (((command === "addtouralert" || command === "addtouralerts") && SESSION.users(src).tiers.indexOf(utilities.find_tier(inputArray[x])) !== -1) ||
                       ((command === "removetouralert" || command === "removetouralerts") && SESSION.users(src).tiers.indexOf(utilities.find_tier(inputArray[x])) === -1)) {
                existArray.push(inputArray[x]);
            } else {
                foundArray.push(inputArray[x]);
                if (command === "addtouralert" || command === "addtouralerts") {                    
