...
* inside the mafia game */
    ...
    this.showRules = function (src, commandData, channel) {
        var mrules = [
            ...
            "±Rules: Do not quote the game bots at all. This is known as 'botquoting'.",
            ...
            "±Rules: If you have doubts or think someone is breaking the rules, use /mafiaadmins to see a list of people who may help!",
            ""
        ];
