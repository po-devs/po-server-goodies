    ...
    for (id in this.submittedAnswers)
    {
        ...
        if (sys.id(name) !== undefined && this.player(name) !== null) {
            ...
            if (ignoreCaseAnswers.indexOf(answer) != -1)
            {
                ...
                if (/asshole|\bdick\b|pussy|bitch|porn|nigga|\bcock\b|\bgay|slut|whore|cunt|penis|vagina|nigger|fuck|faggot|\banus|boner|\btits\b|condom|\brape\b/gi.test(tanswer)) {
