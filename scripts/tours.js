...
var tourmodcommands = [
    "Parameters: They can be used by putting 'gen=x'; 'mode=singles/doubles/triples'; 'type=single/double'; 'wifi=on/off'.",
...
var tourownercommands = [
    "/megauser: Makes someone a megauser. Use /smegauser for a silent promotion.",
...
var serverownercommands = [
    "/tourowner: Makes someone a Tournament Owner. Use /stowner for a silent promotion.",
    "/tourowneroff: Removes someone from Tournament Owner. Use /stowneroff for a silent promotion."
    ];
var tourrules = [
