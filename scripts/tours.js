...
function tourstart(tier, starter, key, parameters) {
    try {
        ...
        for (var x in channels) {
            ...
            sendChanHtmlAll("<timestamp/> A <b><a href='http://wiki.pokemon-online.eu/wiki/index.php?title="+tier.replace(/ /g,"_")+"'>"+tier+"</a></b> "+(!tours.tour[key].event ? "tournament" : "event")+" has opened for signups! (Started by <b>"+html_escape(starter)+"</b>)", channels[x]);
