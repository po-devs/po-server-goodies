    ...
    this.handlers = {
        entry: function () {
            ...
            for (i = 0; i < srcArray.length; ++i) {
                mafia.players[mafia.signups[i]] = { 'name': mafia.signups[i], 'role': mafia.theme.roles[srcArray[i]], 'targets': {}, 'recharges': {}, 'dayrecharges': {}, 'charges' : {} };
        ...
        night: function () {
            ...
            for (var i in mafia.theme.nightPriority) {
                ...
                for (j = 0; j < names.length; ++j) {
                    ...
                    if (mafia.getCharges(player, "night", o.action) !== undefined && mafia.getCharges(player, "night", o.action) !== 0) {
