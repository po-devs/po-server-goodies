...
try { // Do not indent this, it is only until this starts to work
    ...
    if (winners.length > 0) {
		...
		sendChanHtmlAll("<font size=5><font color='#3daa68'><timestamp/> <b>±Psyduck: </font><font size = 5><font color='red'>While you're waiting for another game, why not submit a question? <a href='http://wiki.pokemon-online.eu/wiki/Community:Trivia#Submitting_Questions'>Help and Guidelines are here!</a></b></font>", triviachan);
        this.resetTrivia();
        runUpdate();
