...
var commands = {
    ...
    [
        ...
        "/contributors: to see the list of people who have contribution access.",
        "/league: to see the elite four and gym leaders of PO league",
        ...
        "/importable: to create an importable of your team",
        "/register: to register a channel to yourself",
        "/cauth: to view the channel authority",
        "/myalts: to see your alts",
        "/dwreleased [pokemon]: to see the released status of the pokemon's Dream World Ability"
    ],
    megauser:
    [
    ...
    [
        ...
        "/cmute [person]: to channel mute someone",
        "/cunmute [person]: to channel unmute someone",
        "/cmutes: to view channel mutes",
        "/cbans: to view channel bans",
        "Following only for channel masters:",
        "/ctogglecaps: to allow/disallow caps in the channel",
        "/ctoggleflood: to allow/disallow flood in the channel. Overactive still in effect.",
        "/cban [person]: to channel ban someone",
        "/cunban [person]: to channel unban someone",
    ...
    [
        ...
        "/endcalls: ends the next periodic call",
        ...
        "/mafiaban [person]:[reason]:[time] To ban a player from Mafia. Time is optional and defaults to 7 days",
        ...
        "/userinfo [person]: to display various info about the person (alias: whois)",
        ...
        "/passauth [target]: To give your mods to another megauser (only for mega-mods) or to your online alt",
        "/passauths [target]: To give your mods silently."
    ],
    admin:
    [
        "/memorydump: To see the state of the memory.",
        "/megauser[off] xxx: Tourney powers.",
        "/contributor[off] xxx:what: Indigo access.",
    ...
    [
        ...
        "/periodicsay minutes:channel1,channel2,...:what",
...
inconsistentCheck : function(src, tier) {
    if (!tier) tier = sys.tier(src);
    if (["DW OU", "DW UU", "DW LU", "Wifi OU", "Wifi UU", "Wifi LU", "Wifi LC", "DW LC", "Wifi Ubers", "DW Ubers", "Clear Skies", "Monotype", "Monocolour", "Smogon OU", "Smogon UU", "Smogon RU", "Wifi NU"].indexOf(tier) == -1) {
        return; // only care about these tiers
    }
