...
init : function() {
    ...
    var lclist = ["Bulbasaur", "Charmander", "Squirtle", "Croagunk", "Turtwig", "Chimchar", "Piplup", "Treecko","Torchic","Mudkip"]; //since LC has taken a stance that LC "sets" the pokémon to level to 5, this is technically pointless
    lcpokemons = [];
    for(dwpok in lclist) {
