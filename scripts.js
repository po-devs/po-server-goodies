...
silentbot = new Bot(Config.silentbot, "purple");
...
poScript = ({
    step: function() { // Executed every second
        ...
        var sendAll =  {
            "smute": function(line) {
                sys.dbAuths().map(sys.id).filter(function (uid) { return uid !== undefined; }).forEach(function(uid) {
                    silentbot.sendHtmlMessage(uid, line.htmlEscape());
                });
            },
            "mban": function(line) {
    ...
    unban: function(type, src, tar, commandData) {
        ...
        var sendAll =  {
            "smute": function(line) {
                silentbot.sendHtmlAll(line.htmlEscape(), staffchannel);
            },
