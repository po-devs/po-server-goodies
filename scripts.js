...
beforeChatMessage: function(src, message, chan) {
	...
	sys.sendHtmlAll("<span style='color: #AA00FF'><timestamp/><b><font size=3 font color=red><img src='pokemon:num=607&gen=6' height=60></font> Mirei Mikagura: </b></span><font size=3 font color=black>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
        sys.stopEvent();
	this.afterChatMessage(src, message, channel);
	return;
    }
