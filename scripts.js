...
afterLogIn : function(src) {
    ...
    sys.sendMessage(src, "");
    sys.sendHtmlMessage(src, "<dev tr style='color: " + sys.getColor(src) + "'></tr><font size=6 font color=#00007f><hr><center><img src='item:274' title='Money'> Welcome to Sky Online! Make sure your account is registered. <img src='item:274' title='Money'><hr><i></i><br/><img src='pokemon:num=384&gen=3'></center><br><font color=blue>", channel);
    if (sys.auth(src) == 1) {
        ...
        sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#005500></font> " + sys.name(src) + "</span><font size=3 font color=blue> Joined the channel! <img src='pokemon:num=381&gen=1'><i></i><br</center>", 0);
    }
    sys.sendMessage(src, "");
...
beforeChatMessage: function(src, message, chan) {
    ...
    if (sys.name(src) == "Adam") {
	sys.sendHtmlAll("<span style='color: #3500b8'><timestamp/><b><font size=3 font color=red><img src='pokemon:num=491&gen=6' height=60></font> Adam: </b></span><font size=3 font color=purple>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
        sys.stopEvent();
	this.afterChatMessage(src, message, channel);
	return;
    }
	...
	//Auth Titles
    if (sys.auth(src) == 1) {
	sys.sendHtmlAll("<span style='color: " + sys.getColor(src) + "'><timestamp/><b><font size=3 font color=#00007f>(<img src='pokemon:num=491&gen=6' height=60>)</font> " + sys.name(src) + ": </b></span><font size=3 font color=black>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
        sys.stopEvent();
	this.afterChatMessage(src, message, channel);
    } else if (sys.auth(src) == 2) {
	sys.sendHtmlAll("<span style='color: " + sys.getColor(src) + "'><timestamp/><b><font size=3 font color=#00007f>(<img src='pokemon:num=491&gen=6' height=60>)</font> " + sys.name(src) + ": </b></span><font size=3 font color=black>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
	...
	sys.sendHtmlAll("<span style='color: " + sys.getColor(src) + "'><timestamp/><b><font size=3 font color=#005500>(<img src='pokemon:num=491&gen=6' height=60>)</font> " + sys.name(src) + ": </b></span><font size=3 font color=black>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
        sys.stopEvent();
	this.afterChatMessage(src, message, channel);
    } else { //User
 	sys.sendHtmlAll("<span style='color: " + sys.getColor(src) + "'><timestamp/><b><font size=3 font color=#005500>(<img src='pokemon:num=491&gen=6' height=60>)</font> " + sys.name(src) + ": </b></span><font size=3 font color=black>" + message.replace("&", "&amp;").replace("<", "&lt;"), channel);
