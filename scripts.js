...
afterLogIn : function(src) {
    ...
    sys.sendMessage(src, "");
    if (sys.auth(src) == 1) {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#00007f>(@)</font> " + sys.name(src) + "</span><font size=2 font color=black> Joined the channel!", 0);
    } else if (sys.auth(src) == 2) {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#00007f>(&)</font> " + sys.name(src) + "</span><font size=2 font color=black> Joined the channel!", 0);
    } else if (sys.auth(src) == 3) {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#00007f>(~)</font> " + sys.name(src) + "</span><font size=2 font color=black> Joined the channel!", 0);
    } else if (sys.auth(src) == 4) {
    	sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#005500></font> " + sys.name(src) + "</span><font size=2 font color=black> Joined the channel!", 0);
    } else {
        sys.sendHtmlAll("<timestamp/><span style='color: " + sys.getColor(src) + "'><b><font size=3 font color=#005500></font> " + sys.name(src) + "</span><font size=2 font color=black> Joined the channel!", 0);
    }
    sys.sendMessage(src, "");
